  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 mb-1 whitespace-nowrap">Admin - Tournaments</h1>
          <p className="text-sm text-gray-400 whitespace-nowrap">Create tournaments and manage players</p>
        </div>
        <Link
          href="/admin/tournaments/new"
          className="text-sm bg-green-700 hover:bg-green-800 text-white font-medium px-4 py-2 rounded-lg transition-colors whitespace-nowrap self-end sm:self-auto"
        >
          + Create tournament
        </Link>
      </div>
